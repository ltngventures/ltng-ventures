<script lang="ts">
    ...
    function handleSubmit(event: Event) {
        ...
        miningSituationCheckboxes.forEach(
            (el) => el.checked && miningSituationValues.push(el.value)
        );
        miningNeedsCheckboxes.forEach((el) => el.checked && miningNeedsValues.push(el.value));

        const formDataAsArray = Object.entries(formData);
        const filtered = formDataAsArray.filter(
            ([key, value]) => key !== "miningSituation" && key !== "miningNeeds"
        );
        ...
        >
            ...
            <fieldset class="formGroup">
                ...
                <input
                    ...
                    name="social"
                    id="social"
                    placeholder="Twitter, LinkedIn, Nostr, Telegram, etc."
                    required
                />
            </fieldset>
            ...
            <fieldset class="formGroup">
                ...
                <select bind:value={companySector} name="companySector" id="companySector">
                    ...
                    <option value="Exchanges / On Ramps / Financial"
                        >Exchanges / On Ramps / Financial</option
                    >
            ...
            <fieldset class="formGroup">
                ...
                <select
                    bind:value={companyIncorporated}
            ...
            {#if companyIncorporated}
                <div
                    class="md:col-span-2 grid-cols-1 md:grid-cols-2 gap-8 {companyIncorporated
                        ? 'grid'
                        : 'hidden'}"
                >
                    <fieldset class="formGroup">
                    ...
                    <fieldset class="formGroup">
                        <label for="companyCountryOfIncorporation"
                            >What country is the company based in?</label
                        >
                        <input
                            type="text"
            ...
            <fieldset class="formGroup">
                ...
                <select name="companyStage" id="companyStage" required>
                    ...
                    <option value="Raised from angels and/or friends & family"
                        >Raised from angels and/or friends & family</option
                    >
            ...
            <fieldset class="formGroup">
                ...
                <select name="companyRevenueStatus" id="companyRevenueStatus" required>
                    ...
                    <option value="Post revenue, not profitable"
                        >Post revenue, not profitable</option
                    >
            ...
            <fieldset class="formGroup md:col-span-2">
                <label for="previousFunding"
                    >If you've previously raised, please tell us the month/year you raised each
                    round and all investors in those rounds.</label
                >
            ...
            <fieldset class="formGroup md:col-span-2">
                <label for="exitStrategies"
                    >What are some possible exit strategies? Have their been any recent comparable
                    exits in your industry? Who might be a potential acquirer in the future? *</label
                >
                <span class="sublabel">2-3 paragraphs max</span>
            ...
            <fieldset class="formGroup md:col-span-2">
                <label for="risks"
                    >What risks are you facing? What is the biggest threat to your survival? *</label
                >
                <span class="sublabel">2-3 paragraphs max</span>
            ...
            <fieldset class="formGroup md:col-span-2">
                <label for="traction"
                    >What does your traction look like so far? Any high level KPIs that you can
                    share? *</label
                >
                <span class="sublabel">2-3 paragraphs max</span>
            ...
            <fieldset class="formGroup md:col-span-2">
                <label for="press"
                    >Press, Blogs, Interviews, Podcasts, Media, or anything else to share?</label
                >
            ...
            <fieldset class="formGroup md:col-span-2">
                ...
                {#if showSuccess}
                    <div class="text-green-500 text-center">
                        Thanks! We'll reach out if once we've reviewed.
                    </div>
                {/if}
